...
from .nn_utilities import mean_flat
# from losses.losses import normal_kl, discretized_gaussian_log_likelihood
...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        ...
        # print(f"{x_t.device=}")
        # print(f"{t.device=}")
        # print(f"{self._scale_input(x_t, t).device=}")
    ...
    def p_sample_loop_progressive(
        ...
        z_y = y #self.encode_first_stage(y, first_stage_model, up_sample=True)
    ...
    def training_losses(
        ...
        z_y = y # self.encode_first_stage(y, first_stage_model, up_sample=False) #, up_sample=True)
        z_start = x_start #self.encode_first_stage(x_start, first_stage_model, up_sample=False)
